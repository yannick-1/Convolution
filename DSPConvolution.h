...
public:
    ...
    CabSimulator()
    {
        ...
        convolution.loadImpulseResponse(dir.getChildFile("Resources")
...
private:
    ...
    public:
        ...
        ~DSPTutorialAudioProcessorEditor()
        {
    ...
    private:
        ...
        DSPTutorialAudioProcessor& processor;
